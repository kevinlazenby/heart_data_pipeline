...
# (inactive status), so these may represent data submission errors
...
# 6. Pivot just_form by date, then join with full_list
...
full_list <- full_list %>% 
  ...
  # full join by common variables, thus no need for suffix
  full_join(just_form, by = c("PX_ID", "unique_date", "unique_event")) %>% 
...
# repeat the same process as abovew with just_stat1b
